...
export default function Hero() {
    ...
    // Scroll diagnostics for parallax
    ...
    return (
        <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden bg-pink-50 z-20">
            ...
            <motion.div 
                style={{ y: useTransform(scrollY, [0, 800], [0, 80]), opacity: opacityContent }}
            ...
            <motion.div 
                style={{ opacity: useTransform(scrollY, [0, 200], [0.9, 0]) }}
                className="absolute bottom-6 left-0 right-0 z-30 flex justify-center pointer-events-none animate-bounce"
            >
